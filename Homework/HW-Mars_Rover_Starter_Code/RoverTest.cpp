...
istream& operator>>(istream& is, MyString& str) {
	...
	while (!is.eof()) {
		...
		MyString newStr(newstr); // MyString: copy constructor
		MyString newc;
		newc = newStr;
		delete[] newstr;
...
int main () {
	// const char* newstr = new char[5] {'t', 'h','i','s', '\0'};
	// MyString newStr(newstr); // MyString: copy constructor
	// const char* newstr2 = new char[6] {'r', 'i','g','h', 't', '\0'};
	// MyString newStr2(newstr2); // MyString: copy constructor
	// newStr += newStr2;
	// int sl = newStr.find(newStr2);
